...
const updateAssignment = (
  assign: Assignment,
  propsToUpdata: Partial<Assignment>
): Assignment => {
  return { ...assign, ...propsToUpdata };
};
...
const score: AssignResult = { studentId: "k123", grade: 76 };
...
type AssignPatams = Parameters<typeof createNewAssign>;

const assignArgs: AssignPatams = ["Generics", 100];
